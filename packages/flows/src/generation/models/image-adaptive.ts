...
import { imageReferencesInput } from './image-adaptive-input.js'
import {
  imageEnumSetting,
  imageOutputCountSetting,
} from './image-adaptive-settings.js'
...
export function imageModel(input: {
...
export const NANO_BANANA_2_LITE_MODEL = imageModel({
  ...
  logoId: 'google',
  maxReferences: 14,
  settings: [imageEnumSetting('aspectRatio', GEMINI_ASPECT_RATIOS, '1:1')],
})
...
export const NANO_BANANA_2_MODEL = imageModel({
  ...
  recommended: true,
  settings: [
    imageEnumSetting('aspectRatio', GEMINI_ASPECT_RATIOS, '1:1'),
    imageEnumSetting('resolution', ['512', '1K', '2K', '4K'], '1K'),
  ],
})
...
export const NANO_BANANA_PRO_MODEL = imageModel({
  ...
  maxReferences: 14,
  settings: [
    imageEnumSetting('aspectRatio', GEMINI_PRO_ASPECT_RATIOS, '1:1'),
    imageEnumSetting('resolution', ['1K', '2K'], '1K'),
  ],
})
...
export const SEEDREAM_45_MODEL = imageModel({
  ...
  maxReferences: 14,
  settings: [
    imageEnumSetting('aspectRatio', SEEDREAM_ASPECT_RATIOS, '1:1'),
    imageEnumSetting('resolution', ['1K', '2K', '4K'], '1K'),
    imageOutputCountSetting(10),
  ],
})
...
export const RECRAFT_41_MODEL = imageModel({
  ...
  logoId: 'recraft',
  maxReferences: null,
  settings: [imageOutputCountSetting(6)],
})
