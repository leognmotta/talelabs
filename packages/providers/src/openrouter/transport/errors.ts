/** Stable normalization of OpenRouter HTTP and transport failures. */

import { OpenRouterHttpError } from './contracts.js'

/** Parses a bounded `Retry-After` header into milliseconds. */
...
/** Maps a non-success OpenRouter HTTP response to one stable transport error. */
...
/** Normalizes thrown fetch, timeout, abort, and transport failures. */
