    ...
    props: mergeProps<'button'>(
      {
        className: cn(
          `
            ...
            justify-center rounded-xl p-0 text-sidebar-foreground
...
const sidebarMenuButtonVariants = cva(
  `
    ...
    overflow-hidden rounded-xl px-3 py-2 text-left text-sm ring-sidebar-ring
    ...
    <div
      ...
      className={cn(
        `
          ...
          justify-center rounded-xl px-1 text-xs font-medium
    ...
    props: mergeProps<'a'>(
      {
        className: cn(
          `
            ...
            rounded-xl px-3 text-sidebar-foreground ring-sidebar-ring
            outline-hidden
            group-data-[collapsible=icon]:hidden
            hover:bg-sidebar-accent hover:text-sidebar-accent-foreground
            focus-visible:ring-2
