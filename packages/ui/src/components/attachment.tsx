...
const attachmentVariants = cva(
  `
    ...
    rounded-3xl border bg-card text-card-foreground transition-colors
...
const attachmentMediaVariants = cva(
  `
    ...
    overflow-hidden rounded-2xl bg-muted text-foreground
...
function AttachmentGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        `
          flex min-w-0 scroll-fade-x snap-x snap-mandatory scroll-px-1
