      ...
      >
        <ComboboxPrimitive.Popup
          ...
          className={cn(`
            ...
            origin-(--transform-origin) overflow-hidden rounded-3xl bg-popover
...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        `
          flex min-h-9 flex-wrap items-center gap-1.5 rounded-3xl border
    ...
    <ComboboxPrimitive.Chip
      ...
      className={cn(
        `
          ...
          rounded-3xl bg-input px-2 text-xs font-medium whitespace-nowrap
          text-foreground
