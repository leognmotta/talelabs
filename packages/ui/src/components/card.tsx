    ...
    <div
      ...
      className={cn(
        `
          ...
          rounded-4xl bg-card py-(--card-spacing) text-sm text-card-foreground
          shadow-md ring-1 ring-foreground/5 [--card-spacing:--spacing(6)]
    ...
    <div
      ...
      className={cn(
        `
          ...
          items-start gap-1.5 rounded-t-4xl px-(--card-spacing)
