...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Backdrop
      ...
      className={cn(
        `
          fixed inset-0 z-50 min-h-dvh bg-black/30
...
function DrawerSwipeHandle({
  ...
  return (
    <div
      ...
      className={cn(
        `
          relative z-10 flex shrink-0 cursor-grab transition-opacity
          duration-200
      ...
      >
        <DrawerPrimitive.Popup
          ...
          className={cn(
            // Base.
            `
              group/drawer-popup pointer-events-auto fixed z-50
              m-(--drawer-inset,0px) flex h-(--drawer-content-height)
              ...
              flex-col rounded-4xl border border-popover bg-popover text-sm
              text-popover-foreground shadow-xl
              transition-[transform,height,opacity,filter] duration-450
              ease-[cubic-bezier(0.22,1,0.36,1)] will-change-transform
              outline-none select-none [--drawer-bleed-background:transparent]
