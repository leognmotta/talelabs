    ...
    <MenuPrimitive.Portal>
      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn(`
            z-50 max-h-(--available-height) w-(--anchor-width) min-w-48
    ...
    <MenuPrimitive.Item
      ...
      className={cn(
        `
          ...
          gap-2.5 rounded-2xl px-3 py-2 text-sm font-medium outline-hidden
          select-none
...
function DropdownMenuSubTrigger({
  ...
  return (
    <MenuPrimitive.SubmenuTrigger
      ...
      className={cn(
        `
          flex cursor-default items-center gap-2 rounded-2xl px-3 py-2 text-sm
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn(`
        w-auto min-w-36 rounded-3xl bg-popover p-1.5 text-popover-foreground
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      className={cn(
        `
          relative flex cursor-default items-center gap-2.5 rounded-2xl py-2
