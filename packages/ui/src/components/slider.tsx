    ...
    >
      ...
      >
        <SliderPrimitive.Track
          ...
          className="
            relative grow overflow-hidden rounded-full bg-input/90 select-none
        ...
        {Array.from({ length: _values.length }, (_, index) => (
          <SliderPrimitive.Thumb
            ...
            key={index}
            className="
              block h-4 w-6 shrink-0 rounded-full bg-white shadow-md ring-1
              ring-black/10 transition-[color,box-shadow,background-color]
              select-none
