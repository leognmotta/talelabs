...
function MenubarContent({
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn(`
        min-w-48 rounded-3xl bg-popover p-1.5 text-popover-foreground shadow-lg
    ...
    <MenuPrimitive.CheckboxItem
      ...
      className={cn(
        `
          ...
          pr-3 pl-9.5 text-sm font-medium outline-hidden select-none
          focus:bg-accent focus:text-accent-foreground
...
function MenubarSubTrigger({
  ...
  return (
    <DropdownMenuSubTrigger
      ...
      className={cn(
        `
          gap-2 rounded-2xl px-3 py-2 text-sm font-medium
          focus:bg-accent focus:text-accent-foreground
          data-inset:pl-9.5
...
function MenubarSubContent({
  ...
  return (
    <DropdownMenuSubContent
      ...
      className={cn(`
        min-w-32 rounded-3xl bg-popover p-1.5 text-popover-foreground shadow-lg
        ring-1 ring-foreground/5 duration-100
        data-[side=bottom]:slide-in-from-top-2
        data-[side=left]:slide-in-from-right-2
        data-[side=right]:slide-in-from-left-2
