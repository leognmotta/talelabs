...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        `
          flex w-fit items-center justify-between gap-1.5 rounded-3xl border
          border-transparent bg-input/50 px-3 py-2 text-sm whitespace-nowrap
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(`
            ...
            overflow-y-auto rounded-3xl bg-popover text-popover-foreground
