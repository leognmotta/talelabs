...
import type {
  BillingRunCancellationSettlementTaskPayload,
  BillingWebhookTaskPayload,
} from '../tasks/billing/contracts.js'
import type {
  FlowRunTaskPayload,
...
export interface TriggerTaskMap {
  ...
  'billing-webhook-process': BillingWebhookTaskPayload
  'billing-run-cancellation-settle': BillingRunCancellationSettlementTaskPayload
