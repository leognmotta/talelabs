/** Shared OpenAPI error response declarations for product routes. */
...
/** Standard machine-readable error responses shared by product endpoints. */
export const commonErrorResponses = {
  400: { description: 'Validation error', content: errorContent },
  401: { description: 'Authentication required', content: errorContent },
  402: { description: 'Payment or credit balance required', content: errorContent },
  ...
  503: { description: 'Billing provider temporarily unavailable', content: errorContent },
} as const
