/** Grid-mode folder navigation, selection, drag, and command presentation. */

import type { Folder } from '@talelabs/sdk'
import type { FolderActions } from '../library/asset-actions.types'
import type { AssetLibraryInteractions } from '../library/asset-library.types'
...
/** Binds one folder to navigation while preserving library selection semantics. */
