/** Central command controller for Asset/folder menus and their mutation dialogs. */

import type { Asset, Folder, Tag } from '@talelabs/sdk'
import type { useAssetMutations } from '../data/asset-mutations'
import type { useTagMutations } from '../data/tag-mutations'
import type { MoveDialogTarget } from '../folders/move-to-folder-dialog'
...
/** Rename/create dialog target, or null when no naming dialog is open. */
...
/** Binds library action menus to mutations, selection expansion, dialogs, and toasts. */
