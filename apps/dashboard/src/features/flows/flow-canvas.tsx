...
import { useFlowCanvasCommands } from './use-flow-canvas-commands'
import { useFlowCanvasLifecycle } from './use-flow-canvas-lifecycle'
import { useFlowCanvasReactFlowHandlers } from './use-flow-canvas-react-flow-handlers'
      ...
      <FlowMediaPreviewProvider>
        ...
        <ContextMenu>
          ...
          <FlowCanvasOverlays
            ...
            navigation={lifecycle.navigationDialog}
            shortcutLabels={shortcutLabels}
            onAddNode={commands.addNode}
