/** Chooses the current active run without replacing newer terminal history. */
...
/** Returns generation nodes in the admitted closure that should display active state. */
...
/** Reads active node ids from a run snapshot while respecting terminal status. */
