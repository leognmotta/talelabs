/** Transient progress overlay shown until an upload becomes a canonical Asset. */
...
/** Displays transient canvas upload progress until canonical Asset registration. */
