/** Read-only operation presentation derived from connected inputs and model contract. */
...
/** Selects among model operations and applies the reconciled operation configuration. */
