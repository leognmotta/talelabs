...
/* eslint-disable better-tailwindcss/no-unknown-classes -- React Flow behavior hooks isolate the floating menu. */
...
export function InputReferenceMenu({
  ...
  return (
    <Command
      className="
        nodrag nopan nowheel max-w-72 min-w-56 rounded-xl border shadow-xl
      "
      data-prompt-input-menu=""
      shouldFilter={false}
      value={selected ? itemValue(selected) : undefined}
