...
import { deleteCanvasNodes } from '../../../editor/canvas-state/canvas-node-collection-actions'
...
import { getFlowCanvasShortcutLabels } from '../../../editor/interactions/flow-canvas-shortcuts'
