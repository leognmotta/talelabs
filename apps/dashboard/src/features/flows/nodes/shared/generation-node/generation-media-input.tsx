/** Typed media-input body shared by model-adaptive generation node families. */
...
/** Validation/readiness status displayed for one generation media slot. */
export type GenerationMediaInputStatus
  = | { kind: 'connections', messageKey: string }
    | { kind: 'items', messageKey: string }

/** Slot contract, candidates, and selection commands needed by a media input. */
