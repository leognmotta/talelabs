/** Hover details for one port value, including media and canonical Asset metadata. */
...
/** Displays media thumbnail, identity, metadata, and selection state for one value. */
