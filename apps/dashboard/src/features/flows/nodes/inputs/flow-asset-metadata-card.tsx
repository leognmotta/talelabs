/** Flow input-node presentation for canonical user inputs. */
...
import { formatAssetSize, formatDuration } from '../../../assets/media/asset-formatters'
...
/** Displays canonical Asset dimensions, duration, size, source, and lifecycle metadata. */
