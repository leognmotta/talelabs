...
import { updateCanvasGenerationConfiguration } from '../editor/canvas-state/canvas-generation-actions'
import { updateCanvasNodeData } from '../editor/canvas-state/canvas-node-actions'
import { findCanvasNode } from '../editor/canvas-state/canvas-store'
import {
  getCanvasInputState,
