...
import { createCanvasNode } from '../interactions/flow-canvas-node-factory'
...
export function addCanvasNode(input: {
  ...
  /** Scoped canvas store receiving the new node. */
  store: CanvasStore
...
export function deleteCanvasNodes(
  input: {
    ...
    /** Scoped canvas store receiving the deletion transaction. */
    store: CanvasStore
  },
...
export function duplicateCanvasNodes(
  /** Scoped canvas store receiving the duplication transaction. */
  store: CanvasStore,
