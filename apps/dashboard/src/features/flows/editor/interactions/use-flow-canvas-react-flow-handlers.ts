...
import { syncCanvasSelectionIds } from '../canvas-state/canvas-selection-sync'
import { openCanvasContextMenu } from '../canvas-state/canvas-ui-actions'
...
export function useFlowCanvasReactFlowHandlers(input: {
  ...
  return useMemo(() => {
    ...
    return {
      ...
      onSelectionChange: syncCanvasSelectionIds.bind(null, input.store),
